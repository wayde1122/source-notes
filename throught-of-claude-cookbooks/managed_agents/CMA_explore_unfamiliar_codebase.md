# 《Explore: grounding in an unfamiliar codebase》学习笔记：Claude Managed Agents 托管式 Agent 实践

> 源 Notebook：`managed_agents/CMA_explore_unfamiliar_codebase.ipynb`
...
- **Exploration before action.** A good agent reads enough of the tree to understand it, then answers, not the……
